...
// TODO (prueba social): añadir `testimonial: { quote, author, role }` real a cada
// caso cuando el cliente lo confirme. Activa el <blockquote> en la página de detalle.
// No inventar citas — dejar sin testimonial hasta tener la frase verificada.
