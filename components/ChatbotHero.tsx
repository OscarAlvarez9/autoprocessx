...
const phaseLabels = [
    ...
    { range: [0.33, 0.66], label: "Fase 02 · Conversación viva" },
    { range: [0.66, 1.01], label: "Fase 03 · Pulso sincronizado" },
]
    ...
    return (
        ...
        >
            <div className="sticky top-0 h-screen w-full overflow-hidden">
                ...
                {/* Vignettes — soft so the canvas dominates */}
                ...
                {/* Amber volumetric glows around phone */}
                <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[720px] h-[720px] bg-amber-500/12 blur-[200px] rounded-full pointer-events-none" />
                <div className="absolute right-[20%] top-1/3 w-[280px] h-[280px] bg-amber-300/10 blur-[100px] rounded-full pointer-events-none" />
                        ...
                        <div className="max-w-xl lg:max-w-[44%] relative">
                            ...
                            >
                                ...
                                <span className="relative inline-block">
                                    ...
                                    >
                                        A las 3 de la madrugada también
                                    </span>
                                    <motion.span
                                        initial={{ scaleX: 0 }}
                            ...
                            >
                                ...
                                <span className="text-white/85 font-bold">Chatbots con IA para web y WhatsApp en España.</span> Atención al cliente automatizada 24/7 con agentes que entienden el contexto de tu negocio.
                            </motion.h2>
                            ...
                            >
                                <Button
                                    ...
                                    onClick={() => {
                                        gtagEvent("click_cta_to_form", {
                                            event_category: "cta",
                                            event_label: "chatbot_hero",
                                            location: "chatbot_primary",
                                        })
                                        openDrawer()
                                    }}
                                ...
                                <Link href="#canales" className="w-full sm:w-auto">
                                    <Button
                                        size="lg"
                                        variant="outline"
                ...
                >
                    <span className="text-[9px] font-black uppercase tracking-[0.4em] text-white/40">
                        Scroll para abrir la conversación
                    </span>
                    <motion.div
                        animate={{ y: [0, 6, 0] }}
