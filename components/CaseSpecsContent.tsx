...
export default function CaseSpecsContent({ caso }: Props) {
    return (
        <div className="flex flex-col min-h-screen bg-[#05070F] text-white selection:bg-primary/20">
            ...
            <div className="relative pt-40 pb-24 overflow-hidden border-b border-white/5">
              ...
              <div className="container relative z-10 px-6 mx-auto">
                <Link href="/casos-de-exito" className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.3em] text-white/30 hover:text-accent transition-colors mb-12">
                ...
                <div className="flex flex-col lg:flex-row justify-between items-start gap-16">
                    <div className="max-w-4xl">
                        ...
                        <motion.h1 
                            ...
                            className="text-5xl md:text-[88px] font-black tracking-tighter leading-[0.85] text-white mb-10"
                        >
                            Infrastructure <span className="text-accent italic">Report.</span><br />
                            {caso.title}
                        </motion.h1>
                        <p className="text-2xl text-white/40 font-medium italic leading-tight max-w-2xl">
                            {caso.desc}
                        </p>
                    </div>

                    <div className="w-full lg:w-[380px] p-10 rounded-[48px] bg-white/[0.02] border border-white/5 backdrop-blur-3xl">
                        <p className="text-[10px] font-black uppercase tracking-[0.3em] text-accent mb-8">Base Technology Stack</p>
            ...
            <section className="py-32 bg-[#0F1424] border-b border-white/5">
                    ...
                    <div className="grid lg:grid-cols-12 gap-24 items-center">
                        <div className="lg:col-span-8">
                            <motion.div 
                                ...
                                viewport={{ once: true }}
                                className={`relative ${caso.theme === 'dark' || caso.image.includes('workflow') ? 'bg-black' : 'bg-white/5'} rounded-[64px] overflow-hidden border border-white/10 shadow-2xl p-6 md:p-12 group`}
                            >
                        ...
                        <div className="lg:col-span-4">
                            ...
                            <h2 className="text-4xl md:text-5xl font-black tracking-tighter mb-12 leading-[0.9]">Arquitectura del <br /><span className="text-accent italic">Proceso.</span></h2>
                            <div className="space-y-10">
                                <div className="flex gap-8 group">
                                    <div className="h-14 w-14 rounded-[20px] bg-white/[0.02] border border-white/5 flex items-center justify-center shrink-0 group-hover:border-accent/50 transition-colors">
                                        <Network className="h-6 w-6 text-accent" />
                                    </div>
                                    <div>
                                        <h4 className="font-black text-xl mb-3 tracking-tight">Orquestación de Procesos</h4>
                                ...
                                <div className="flex gap-8 group">
                                    ...
                                    <div>
                                        <h4 className="font-black text-xl mb-3 tracking-tight">Procesamiento de Lenguaje</h4>
                                ...
                                <div className="flex gap-8 group">
                                    ...
                                    <div>
                                        <h4 className="font-black text-xl mb-3 tracking-tight">Integridad de Sistemas</h4>
            ...
            {caso.slug === 'business-suite-ia-plataforma-corporativa' && (
                <section className="py-32 bg-[#05070F] border-b border-white/5">
                    <div className="container px-6 mx-auto">
                        ...
                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                            {platformModules.map((mod, i) => (
                                <motion.div
                                    ...
                                    className="rounded-[56px] bg-white/[0.02] border border-white/5 overflow-hidden hover:border-accent/30 transition-all group"
                                >
                                    <div className="p-12 pb-0">
                                        <span className={`text-[10px] font-black uppercase tracking-widest px-4 py-2 rounded-full border ${mod.tagColor}`}>{mod.tag}</span>
                                        <h3 className="text-3xl font-black mt-8 mb-4 tracking-tighter">{mod.title}</h3>
                                        <p className="text-white/40 text-base font-medium leading-tight mb-10">{mod.desc}</p>
                                    </div>
                                    <div className="mx-8 mb-8 rounded-[40px] overflow-hidden bg-black aspect-[16/9] border border-white/5 shadow-2xl relative">
                        ...
                        <motion.div
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="rounded-[64px] bg-white/[0.02] border border-white/5 overflow-hidden hover:border-accent/30 transition-all group"
                        >
                            <div className="p-12 pb-0">
                                <div className="flex flex-col md:flex-row md:items-start md:justify-between gap-12 mb-10">
                                    <div className="flex-1">
                                        <span className="text-[10px] font-black uppercase tracking-widest text-accent bg-accent/5 px-4 py-2 rounded-full border border-accent/10">Multi-Agent Protocol</span>
                                        <h3 className="text-4xl font-black mt-8 mb-4 tracking-tighter">Equipo de Agentes IA Autónomos</h3>
                                        <p className="text-white/40 text-lg font-medium leading-tight max-w-3xl">
                                    ...
                                    <div className="flex flex-wrap gap-3 md:justify-end">
                                        {["🧠 Multi-model", "🔗 Inter-Agent Comms", "📄 Context Aware", "🌙 Autonomous"].map((tag, i) => (
                                            <span key={i} className="px-4 py-2 rounded-full bg-white/5 text-[10px] font-black uppercase tracking-widest text-white/30 border border-white/5 whitespace-nowrap">
                                                {tag}
                                            </span>
                                        ))}
                                    </div>
                            ...
                            <div className="mx-12 mb-12 rounded-[48px] overflow-hidden bg-black aspect-[16/6] border border-white/5 shadow-2xl relative">
            ...
            <section className="py-32 bg-[#0F1424] border-b border-white/5">
                <div className="container px-6 mx-auto">
                    <div className="max-w-5xl mx-auto">
                        ...
                        <h2 className="text-5xl md:text-7xl font-black tracking-tighter mb-24 text-center leading-[0.85]">Evolución del <span className="text-accent italic">Despliegue.</span></h2>
                            ...
                            <div className="space-y-16">
                                {caso.phases.map((phase, i) => (
                                    <motion.div 
                                        ...
                                        className={`relative flex flex-col md:flex-row gap-12 items-start md:items-center ${i % 2 !== 0 ? 'md:flex-row-reverse' : ''}`}
                                    >
                                        <div className="h-20 w-20 rounded-[28px] bg-[#05070F] border border-white/10 flex items-center justify-center shrink-0 md:z-10 shadow-2xl text-2xl font-black italic text-accent group-hover:border-accent transition-colors">
                                            {phase.phase}
                                        </div>
                                        <div className={`flex-1 p-12 rounded-[48px] bg-white/[0.02] border border-white/5 hover:border-accent/20 transition-all ${i % 2 !== 0 ? 'md:text-right' : 'md:text-left'}`}>
                                            <h3 className="text-2xl font-black mb-4 tracking-tight text-white uppercase">{phase.title}</h3>
                                            <p className="text-white/30 text-lg font-medium leading-tight italic">{phase.description}</p>
                                        </div>
                                    </motion.div>
                                ))}
                            </div>
            ...
            <section className="py-32 bg-[#05070F]">
                <div className="container px-6 mx-auto">
                    <div className="flex flex-col md:flex-row items-center justify-center gap-4 mb-24">
                        <Terminal className="h-6 w-6 text-accent" />
                        <h2 className="text-3xl md:text-5xl font-black tracking-tighter text-center uppercase">Audit de <span className="text-accent italic">Rendimiento Técnico.</span></h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 max-w-7xl mx-auto">
                        {caso.metricsArray.map((m, i) => (
                            <motion.div 
                                ...
                                whileInView={{ opacity: 1, y: 0 }}
                                viewport={{ once: true }}
                                className="p-12 rounded-[56px] border border-white/5 bg-white/[0.02] text-center hover:border-accent/30 transition-all group relative overflow-hidden"
                            >
                                <div className="absolute top-0 right-0 p-6 text-white/5 group-hover:text-accent/10 transition-colors">
                                    {m.icon}
                                </div>
                                <p className="text-6xl font-black tracking-tighter mb-4 text-white group-hover:text-accent transition-colors">{m.value}</p>
                                <p className="text-[10px] font-black uppercase tracking-[0.3em] text-white/30">{m.label}</p>
                            </motion.div>
                        ))}
                        ...
                        <motion.div 
                            ...
                            whileInView={{ opacity: 1, y: 0 }}
                            viewport={{ once: true }}
                            className="p-12 rounded-[56px] border border-accent/20 bg-accent/5 text-center shadow-2xl shadow-accent/10 relative overflow-hidden group"
                        >
                            ...
                            <div className="relative z-10">
                                ...
                                <p className="text-2xl font-black tracking-tight mb-2 leading-none text-white uppercase italic">Impacto ROI</p>
                                <p className="text-6xl font-black tracking-tighter text-accent">{caso.secondaryMetric.split(' ')[1]}</p>
                            </div>
                        </motion.div>
                    </div>
                </div>
