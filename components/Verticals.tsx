...
export default function Verticals() {
    return (
        <section id="ventajas" className="py-20 md:py-28 text-[#09090B] overflow-hidden relative">
            ...
            <div className="container px-6 mx-auto relative z-10 max-w-6xl">
                ...
                <div className="text-center mb-14 md:mb-20 max-w-3xl mx-auto">
                    ...
                    <p className="text-zinc-600 text-base md:text-lg font-medium leading-relaxed max-w-2xl mx-auto">
                        Automatizaciones, plataformas con agentes y chatbots desplegados como sistema unificado. Una vez. Bajo tu propiedad. Pagas el desarrollo y el consumo real de servidores, no una suscripción por cada empleado que entra en tu equipo.
                    </p>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 md:gap-6 mb-14 md:mb-20">
                    ...
                    <motion.div
                        ...
                        viewport={{ once: true }}
                        className="relative p-6 md:p-8 rounded-2xl border border-[#E4E4E7] bg-[#FFFFFF] overflow-hidden"
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className="mb-6">
                                <div className="text-[10px] font-black uppercase tracking-[0.25em] text-zinc-500 mb-1">
                                    Empresa 50 personas
                                </div>
                                <div className="flex items-baseline gap-2">
                                    <span className="text-3xl md:text-4xl font-black text-zinc-600 line-through decoration-red-500/50 decoration-2">
                                        2.400€
                                    </span>
                            ...
                            <ul className="space-y-2.5">
                                {saasRows.map((row) => (
                                    <li key={row} className="flex items-start gap-2.5">
                                        ...
                                        <span className="text-sm text-zinc-600 font-medium leading-snug">{row}</span>
                                    </li>
                                ))}
                            </ul>
                        </div>
                    ...
                    <motion.div
                        ...
                        className="relative p-6 md:p-8 rounded-2xl border border-accent/30 bg-gradient-to-br from-accent/[0.06] to-transparent overflow-hidden shadow-[0_0_40px_-12px_rgba(180,151,90,0.3)]"
                    >
                        ...
                        <div className="relative">
                            ...
                            <div className="mb-6">
                                ...
                                <div className="text-xs font-bold text-accent/80 mt-1">
                                    + hosting propio · sin peajes por usuario
                                </div>
                            </div>
                            <ul className="space-y-2.5">
                                {ownedRows.map((row) => (
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-5">
                    {advantages.map((a, i) => (
                        <motion.div
                            ...
                            className="p-5 md:p-6 rounded-2xl bg-[#FFFFFF] border border-[#E4E4E7] hover:border-accent/30 transition-all"
                        >
                            ...
                            <h3 className="text-base md:text-lg font-black tracking-tight text-[#09090B] mb-2">
                                {a.title}
                            </h3>
