    ...
    return (
        <section className="relative z-10 px-4 py-20 md:py-28 md:px-8 overflow-hidden bg-[#05070F]">
            ...
            >
                ...
                <div className="relative pt-16 pb-10 md:pt-20 md:pb-14 bg-gradient-to-br from-[#0B0E1A] via-[#0a0d18] to-[#0B0E1A] border border-amber-400/20 rounded-[32px] md:rounded-[48px] overflow-hidden shadow-[0_30px_120px_-20px_rgba(251,191,36,0.25)]">
                    ...
                    <div className="relative z-10 px-6 md:px-12 text-center max-w-3xl mx-auto mb-10 md:mb-12">
                        <motion.div
                            ...
                            className="inline-flex items-center gap-2.5 px-4 py-1.5 rounded-full bg-amber-400/10 border border-amber-400/40 backdrop-blur-md mb-7"
                        >
                        ...
                        <h2 className="text-3xl md:text-5xl lg:text-6xl font-black text-white tracking-[-0.025em] leading-[0.95] mb-5">
                            Agenda tu{" "}
                        ...
                        <p className="text-white/70 text-sm md:text-base font-medium leading-relaxed max-w-2xl mx-auto">
                    ...
                    <div className="relative z-10 px-3 sm:px-6 md:px-10">
                        <div className="rounded-2xl overflow-hidden border border-white/10 bg-[#0F1424]">
                            <CalendlyInline />
                        </div>
                    </div>

                    {/* Reassurance row */}
                    <div className="relative z-10 mt-8 md:mt-10 px-6 flex flex-wrap items-center justify-center gap-x-6 gap-y-2 text-xs text-white/55 font-medium">
                        <div className="flex items-center gap-2">
                            <Clock className="h-3.5 w-3.5 text-amber-400" />
                            <span>30 min · Videocall</span>
                        </div>
